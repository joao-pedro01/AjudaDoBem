...
<section id="header">
	<a href="/AjudaDoBem/src/index.php"><img src="/AjudaDoBem/src/views/images/logo_oficial.png" class="logo" alt="logo"></a>

	<div>
		<ul id="navbar">
			<li><a class="active" href="/AjudaDoBem/src/index.php">Home</a></li>
			<li><a href="/AjudaDoBem/src/views/pages/doacao.php">Doações</a></li>
